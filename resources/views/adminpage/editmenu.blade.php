...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admineditmenu.css') }}" />
...
<body id="body-pd">
    ...
    <div class="height-100 bg-light content">
        <a href="">
            < back</a>
                <br><br>
                <h1 class="text-align-start">Edit Menu</h1>
                <hr>
                <br>
                <br>
                        ...
                        <div class="row">
                            <div class="col-5">
                                <img src="{{ asset('images/menu4.png') }}"
                                    alt=""style="width: 500px; height: 300px; border-radius: 10px;">
                            </div>
                            <div class="col-7">
                                <div class="row"> <input type="text" class="box" placeholder="Menu Name...">
                                </div>
                                <div class="row"> <input type="text" class="box" placeholder="Menu Name...">
                                </div>
                                <div class="row"> <input type="text" class="box" placeholder="Menu Name...">
                                </div>
                                <div class="row py-1"><label class="dropdown">
                                ...
                                <div class="row">
                                    <div class="row"> <input type="text" class="box"
    ...
    <script src="{{ asset('js/admineditmenu.js') }}"></script>
